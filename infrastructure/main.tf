...
// Deploying the Auto Scaling Group module
module "asg" {
  source           = "./modules/asg"
  name             = var.asg_name
  vpc_id           = module.vpc.vpc_id
  ecs_cluster_name = var.ecs_cluster_name
  frontend_subnets = slice(module.vpc.vpc_private_subnets, 0, 2)
  depends_on       = [module.vpc]
}
...
module "ecs" {
  ...
  depends_on       = [module.vpc, module.alb, module.asg]
  # depends_on       = [module.vpc, module.alb, module.asg, module.ingress-lb]
}
